...
-- Dumping data for table inventory_system.canvas_items: ~13 rows (approximately)
...
-- Dumping data for table inventory_system.companies: ~1 rows (approximately)
...
-- Dumping data for table inventory_system.company_prices: ~2 rows (approximately)
INSERT INTO `company_prices` (`id`, `item_id`, `company_id`, `quantity`, `price`, `availability`, `company_color`, `created_at`, `updated_at`) VALUES
	...
	(20, 17, 5, 0, 60.00, 1, '#4e73df', '2026-03-27 09:14:33', '2026-03-31 01:37:18');
...
INSERT INTO `products` (`id`, `item_no`, `name`, `description`, `price`, `quantity`, `category`, `unit`, `low_stock_threshold`, `created_at`, `updated_at`) VALUES
	(39, '91', '90 - CAT', 'CAT', 30.00, 0, '0', 'pcs', 10, '2026-03-27 08:56:42', '2026-03-31 01:36:18'),
	(40, '92', '92 - CAT', 'CAT', 30.00, 31, '0', '0', 10, '2026-03-27 09:10:55', '2026-03-31 02:03:33'),
	(41, '93', '93 - CAT', 'CAT', 30.00, 0, '0', '0', 10, '2026-03-27 09:13:10', '2026-03-30 07:54:14');
...
INSERT INTO `purchases` (`id`, `purchase_number`, `customer_name`, `item_no`, `description`, `category`, `unit`, `company_name`, `contact_person`, `contact_number`, `price_id`, `product_id`, `quantity_purchased`, `price_per_unit`, `total_amount`, `delivery_date`, `available_before`, `available_after`, `company_color`, `payment_method`, `payment_status`, `status`, `purchase_date`, `updated_at`, `stock_updated`, `stock_movement_id`) VALUES
	...
	(61, 'PUR-20260331013712-7316', 'Walk-in Customer', '92', 'cat', NULL, 'pcs', 'DIY', 'KIRTIE', '0700707', 20, 40, 39, 60.00, 2340.00, '2026-03-31', 39, 0, '#1cc88a', 'cash', 'pending', 'completed', '2026-03-30 16:00:00', '2026-03-31 01:37:18', 1, 67);
...
INSERT INTO `sites` (`id`, `site_name`, `location_description`, `created_at`, `updated_at`) VALUES
	...
	(2, 'PGH', 'Bangad', '2026-03-30 06:54:21', '2026-03-30 06:54:21');
...
-- Dumping data for table inventory_system.stock_movements: ~9 rows (approximately)
INSERT INTO `stock_movements` (`id`, `product_id`, `type`, `quantity`, `reference`, `notes`, `created_at`, `created_by`, `site_location`) VALUES
	...
	(64, 39, 'out', 1, '', '', '2026-03-29 17:33:00', 3, 'PLDT'),
	(65, 41, 'out', 1, '', '', '2026-03-29 23:53:00', 3, 'PGH'),
	(66, 39, 'out', 1, '', '', '2026-03-30 17:36:00', 3, 'PGH'),
	(67, 40, 'in', 39, 'PURCHASE #PUR-20260331013712-7316', 'Ordered from DIY - Qty: 39', '2026-03-30 16:00:00', 3, NULL),
	(68, 40, 'out', 3, '', '', '2026-03-30 17:37:00', 3, 'PGH'),
	(69, 40, 'out', 4, '', '', '2026-03-30 17:38:00', 3, 'PGH'),
	(70, 40, 'out', 1, '', '', '2026-03-31 18:03:00', 3, 'PGH');
