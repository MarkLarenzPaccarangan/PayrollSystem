...
<body>
    ...
    <!-- Attendance Table - ADDED Site Assignment column -->
    <table>
        <thead>
            <tr>
        ...
        <tbody>
            ...
            <tr class="<?= $row_class ?><?= $has_night ? ' night-shift' : '' ?>">
                ...
                <td class="site-assignment-cell">
                    <?php if ($has_site): ?>
                        <?php if ($site_am != ''): ?>
                            <div><span class="site-label am">AM:</span> <?= htmlspecialchars($site_am) ?></div>
                        <?php endif; ?>
                        <?php if ($site_pm != ''): ?>
                            <div><span class="site-label pm">PM:</span> <?= htmlspecialchars($site_pm) ?></div>
                        <?php endif; ?>
                        <?php if ($site_night != ''): ?>
                            <div><span class="site-label night">Night:</span> <?= htmlspecialchars($site_night) ?></div>
                        <?php endif; ?>
                    <?php else: ?>
                        -
                    <?php endif; ?>
