...
-- Dumping data for table inventory_system.canvas_items: ~11 rows (approximately)
INSERT INTO `canvas_items` (`id`, `item_no`, `description`, `quantity`, `unit`, `united_power_price`, `united_power_availability`, `vicsteel_price`, `vicsteel_availability`, `anakko_price`, `anakko_availability`, `rclquintera_price`, `rclquintera_availability`, `created_at`, `updated_at`) VALUES
	...
	(72, '0123', 'hahaha', 0, NULL, 0.00, 0, 0.00, 0, 0.00, 0, 0.00, 0, '2026-03-06 02:26:21', '2026-03-06 02:26:21');
...
INSERT INTO `companies` (`id`, `name`, `description`, `contact_person`, `contact_number`, `status`, `created_at`, `updated_at`) VALUES
	(1, 'fujiko', '', NULL, NULL, 'active', '2026-03-05 08:43:32', '2026-03-05 08:43:32'),
	(2, 'kikoy', 'dsdsa', NULL, NULL, 'active', '2026-03-05 08:48:04', '2026-03-05 08:48:04'),
	(3, 'jlc', NULL, NULL, NULL, 'active', '2026-03-05 11:30:05', '2026-03-05 11:30:05'),
	(4, 'jj', NULL, 'kk', NULL, 'active', '2026-03-06 01:10:33', '2026-03-06 01:10:33'),
	(5, 'clyde', NULL, '0997', NULL, 'active', '2026-03-06 02:26:21', '2026-03-06 02:26:21');
...
-- Dumping data for table inventory_system.company_prices: ~5 rows (approximately)
INSERT INTO `company_prices` (`id`, `item_id`, `company_id`, `quantity`, `price`, `availability`, `company_color`, `created_at`, `updated_at`) VALUES
	(2, 68, 2, 80, 1000.00, 1, '#4e73df', '2026-03-05 08:48:41', '2026-03-05 08:48:41'),
	(3, 70, 3, 1, 500.00, 1, '#4e73df', '2026-03-05 11:30:05', '2026-03-06 06:42:28'),
	(5, 67, 1, 29, 80.00, 1, '#4e73df', '2026-03-05 11:36:31', '2026-03-05 11:36:31'),
	(6, 71, 4, 37, 6.00, 1, '#4e73df', '2026-03-06 01:10:33', '2026-03-06 14:58:29'),
	(7, 72, 5, 12, 1.00, 1, '#4e73df', '2026-03-06 02:26:21', '2026-03-06 09:06:38');
