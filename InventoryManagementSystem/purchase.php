                ...
                const content = `
                    <div style="padding: 10px;">
                        ...
                        <div style="overflow-x: auto; margin-top: 15px;">
                            <table class="products-table" style="min-width: 1300px;" id="historyTable">
                                <thead>
                                    <tr>
...
// Add this new function for searching transaction history
function searchHistory() {
    ...
    rows.forEach(row => {
        ...
        const rowText = `${itemNo} ${description} ${company} ${contact} ${qty} ${price} ${total} ${status} ${date}`;
